...
import com.myprojects.ebankingbackend.entities.*;
...
import com.myprojects.ebankingbackend.repositories.AccountOperationRepository;
import com.myprojects.ebankingbackend.repositories.BankAccountRepository;
import com.myprojects.ebankingbackend.repositories.CustomerRepository;
...
public class BankAccountServiceImpl implements BankAccountService{
    ...
    public void debit(String accountId, double amount, String description) throws BankAccountNotFoundException, BalanceNotSufficientException {
        BankAccount bankAccount = bankAccountRepository.findById(accountId).
                orElseThrow(()-> new BankAccountNotFoundException("Account not found"));        if(bankAccount.getBalance() < amount)
    ...
    public void credit(String accountId, double amount, String description) throws BankAccountNotFoundException {
        BankAccount bankAccount = bankAccountRepository.findById(accountId).
                orElseThrow(()-> new BankAccountNotFoundException("Account not found"));        AccountOperation accountOperation = new AccountOperation();
